...
class GraduatedColorsRenderer(object):
    def __init__(self):
        ...
        self.description = "create a graduated colored map based on a specific atttribute of a layer"
    ...
    def execute(self, parameters, messages):
        ...
        # Define Progressor Varaibles
        readTime = 3 #the time for users to read the progess
        ...
        time.sleep(readTime) # pause the exeution for 2.5 seconds 
        ...
        # Param 2 is a folder location and param 3 is the name of the new project
        return
